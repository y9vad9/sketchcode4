...
public class MyPostsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        profilesManager = new ProfilesManager(MainActivity.activity);
        profilesManager.loadUserPost(getActivity().getIntent().getStringExtra("id"), new ProfilesManager.Profile() {
            @Override
            public void onLoad(String data) {
                try {
                    ArrayList<HashMap<String, Object>> map = JsonUtil.ArrayfromJson(data);
                    Collections.reverse(map);
                    mAdapter = new Home3Adapter(map);
...
class Home3Adapter extends RecyclerView.Adapter<Home3Adapter.ViewHolder> {
    ...
    public Home3Adapter(ArrayList<HashMap<String, Object>> myDataset) {
    ...
    @Override
    public Home3Adapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                      int viewType) {
        // create a new view
