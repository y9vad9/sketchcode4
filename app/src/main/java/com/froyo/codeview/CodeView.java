...
public class CodeView extends WebView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs,
                com.sketch.code.two.R.styleable.CodeView, 0, 0);
        //Define os atributos
        setWrapLine(attributes.getBoolean(com.sketch.code.two.R.styleable.CodeView_cv_wrap_line, false));
        setFontSize(attributes.getInt(com.sketch.code.two.R.styleable.CodeView_cv_font_size, 14));
        setZoomEnabled(attributes.getBoolean(com.sketch.code.two.R.styleable.CodeView_cv_zoom_enable, false));
        setShowLineNumber(attributes.getBoolean(com.sketch.code.two.R.styleable.CodeView_cv_show_line_number, false));
        setStartLineNumber(attributes.getInt(com.sketch.code.two.R.styleable.CodeView_cv_start_line_number, 1));
        highlightLineNumber = attributes.getInt(com.sketch.code.two.R.styleable.CodeView_cv_highlight_line_number, -1);
        attributes.recycle();
